...
class SegPieceTransfor(object):
    ...
    def __call__(self, img, target):
        ...
        target_trans = F.piecewise_transform(target, self.numcols, self.numrows, self.warp_left_right,
                                             self.warp_up_down, order=0)
...
class SegPieceTransform(object):
    ...
    def __call__(self, img, target):
        ...
        target_transform = F.piecewise_transform(target, self.numcols, self.numrows, self.warp_left_right,
                                                 self.warp_up_down)
